...
export async function POST(req: NextRequest) {
    try {
        ...
        // Use the Lynq service account to initiate CSS switch requests via direct HTTP
        ...
        for (const merchantId of merchantIds) {
            try {
                // CSS switch request via the Content API for Shopping
                // Equivalent to "Add a merchant" → "Request switch" in CSS Center
