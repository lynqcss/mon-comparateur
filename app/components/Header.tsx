            ...
            {isMenuOpen && (
                <div className="md:hidden border-t border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 py-4 px-4 space-y-4 shadow-lg absolute w-full left-0">
                    <nav className="flex flex-col gap-4 text-base font-medium text-zinc-900 dark:text-white">
                        <Link prefetch={false} href={buildUrl('/products')} onClick={() => setIsMenuOpen(false)} className="px-2 py-2 hover:bg-zinc-50 dark:hover:bg-zinc-900 rounded-lg">
                            {t.nav.products}
                        </Link>
                        <Link prefetch={false} href={buildUrl('/merchants')} onClick={() => setIsMenuOpen(false)} className="px-2 py-2 hover:bg-zinc-50 dark:hover:bg-zinc-900 rounded-lg">
                            {t.nav.merchants}
                        </Link>
                    </nav>
