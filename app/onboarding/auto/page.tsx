                    ...
                    <div className="text-center">
                        ...
                        <div className="mt-6 rounded-2xl border border-zinc-200 bg-zinc-50 p-6 text-center">
                            <p className="text-sm text-zinc-600">
                                Besoin d&apos;aide pour valider le switch ? Contactez : <a href="mailto:contact@lynq-css.com" className="font-bold text-zinc-900 underline underline-offset-2 hover:text-zinc-700">contact@lynq-css.com</a>
                            </p>
                        </div>
